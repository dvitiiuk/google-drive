...
public class GoogleSheetsSinkClientTest {
  ...
  @Test
  public void testPrepareFlatternedRequest() throws NoSuchMethodException, InvocationTargetException,
    IllegalAccessException {
    ...
    Method prepareContentRequestMethod =
      GoogleSheetsSinkClient.class.getDeclaredMethod("prepareFlatternedRequest", Integer.class,
        FlatternedRowsRecord.class, int.class);
    prepareContentRequestMethod.setAccessible(true);

    FlatternedRowsRequest request = (FlatternedRowsRequest) prepareContentRequestMethod
   ...
   */
  @Test
  public void testPrepareFlatternedRequestComplex() throws NoSuchMethodException, InvocationTargetException,
    IllegalAccessException {
